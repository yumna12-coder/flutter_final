...
import 'screens/getNotification/Notification.dart';
...
Future main() async {
  ...
  await FirebaseMessagingToProject().initNotification();
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
     ...
     // initialRoute: '/center',
      title: 'Flutter Demo',
     theme: ThemeData.light(), // Define your themes here
      darkTheme: ThemeData.dark(),
      home: const SignIn(), //here
    );
  }
}
